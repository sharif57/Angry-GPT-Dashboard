  ...
  return (
    ...
    <div className="w-full h-[88px] flex justify-between items-center  py-[16px] px-[32px] shadow-lg bg-[#212121] text-white border-[#CAEA31] border rounded-lg">
      <div className="text-start space-y-0.5">
        ...
        <p className="text-sm md:text-xl text-[#999999]">{"Have a nice day!"}</p>
      </div>
      <div className="flex gap-x-[41px]">
        ...
        >
          <Badge style={{ backgroundColor: "#CAEA31", width: '20px', height: '20px', objectFit: 'contain', color:'black' }} count={1}>
            <TbBellRinging
